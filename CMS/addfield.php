                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <label for="destination">
                                                <input type="text" class="form-control" placeholder="Enter the destination." name="destination" id="destination"/>
                                        </div> 
                                        <div class="form-group">
                                                <input type="number" class="form-control" placeholder="Enter the price." name="price" id="price"/>
                                        </div>
                                        <div class="form-group">
                                        <textarea class="form-control" name="description" rows="10" cols="30" placeholder="Write the description."></textarea>
